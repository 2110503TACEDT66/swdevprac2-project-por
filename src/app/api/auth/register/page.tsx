...
export default async function RegisterPage() {
    ...
    return (
        <main className="m-5 p-5 flex justify-center items-center font-mono">
    <form className="w-[80%] max-w-xl flex flex-col items-center space-y-4 bg-stone-200 rounded-xl p-8" action={addUser}>
        <div className="text-4xl p-10 font-bold">Register</div>
        ...
        <button type="submit" className="bg-gray-600 hover:bg-stone-400 text-white rounded-xl px-3 py-2 font-sans font-bold">Register</button>
    </form>
</main>
